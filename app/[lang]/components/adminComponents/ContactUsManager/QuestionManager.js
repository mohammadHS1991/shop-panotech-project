...
import { selectAllQuestions } from '@/app/[lang]/reducers/questionSlice';
...
//? ========================  START useSelector  ========================
    const contactUsComments = useSelector(selectAllQuestions)
//? ========================= /END useSelector =========================
                ...
                contactUsComments && contactUsComments.map((comment, index)=>(
                    ...
                    >
                        <header className='mb-4 pb-1 border-b-2 border-green-900 flex justify-between items-center'>
                            ...
                            <DeleteQuestionModal commentId={comment?._id}/>
                        </header>
